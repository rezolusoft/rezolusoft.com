export default function Contact() {
  return (
    <>
      {/* contact-area-start */}
      <section className="contact-area theme-bg-3 pt-120 pb-120" id="contact">
              ...
              <div className="tpcontact-box pr-70 mb-30">
                <div className="tpsection__content">
                  ...
                  <h2 className="tpsection-title tpsection-title-white mb-50">
                    Parlez nous de <br /> vos besoins.
                  </h2>
                </div>
                <div className="tpcontact-info">
                  <div className="tpcontact-info-links">
                    <a href="mailto:info@rezolusoft.com">
                      <i>
                        <svg
                          width={20}
                          height={18}
                    ...
                    <a href="tell:0123456789">
                      <i>
                        ...
                        >
                          ...
                          <path
                            opacity="0.4"
                            d="M17 6.6C17 3.504 14.496 1 11.4 1"
                            stroke="white"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                  ...
                  <div className="tpcontact-info-social">
                    <a href="https://web.facebook.com/profile.php?id=61561705828400" target="blank" className="mr-4">
                      <i className="fa-brands fa-facebook-f" />
                    </a>
                    <a href="#" className="mr-4">
                      <i className="fa-brands fa-twitter" />
                    </a>
                    <a href="https://github.com/rezolusoft" target="blank" className="mr-4">
